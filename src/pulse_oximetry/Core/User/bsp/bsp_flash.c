...
{
  __ASSERT((src_sector_addr >= BSP_FLASH_SECTOR_0_ADDRESS) && (src_sector_addr <= BSP_FLASH_SECTOR_7_ADDRESS),
           BSP_FLASH_ERROR);
  __ASSERT((dest_sector_addr >= BSP_FLASH_SECTOR_0_ADDRESS) &&
             (dest_sector_addr <= BSP_FLASH_SECTOR_7_ADDRESS),
           BSP_FLASH_ERROR);
