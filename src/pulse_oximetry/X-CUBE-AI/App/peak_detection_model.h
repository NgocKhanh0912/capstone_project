/**
  ...
  ******************************************************************************
  */
#ifndef AI_PEAK_DETECTION_MODEL_H
#define AI_PEAK_DETECTION_MODEL_H

#include "peak_detection_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PEAK_DETECTION_MODEL_MODEL_NAME          "peak_detection_model"
#define AI_PEAK_DETECTION_MODEL_ORIGIN_MODEL_NAME   "dilated_cnn_peak_detection_model"

/******************************************************************************/
#define AI_PEAK_DETECTION_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PEAK_DETECTION_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PEAK_DETECTION_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PEAK_DETECTION_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_PEAK_DETECTION_MODEL_IN \
  ai_peak_detection_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PEAK_DETECTION_MODEL_IN_SIZE { \
  AI_PEAK_DETECTION_MODEL_IN_1_SIZE, \
}
#define AI_PEAK_DETECTION_MODEL_IN_SIZE_BYTES { \
  AI_PEAK_DETECTION_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_PEAK_DETECTION_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PEAK_DETECTION_MODEL_IN_1_HEIGHT      (256)
#define AI_PEAK_DETECTION_MODEL_IN_1_CHANNEL     (1)
#define AI_PEAK_DETECTION_MODEL_IN_1_SIZE        (256)
#define AI_PEAK_DETECTION_MODEL_IN_1_SIZE_BYTES  (1024)

/******************************************************************************/
#define AI_PEAK_DETECTION_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PEAK_DETECTION_MODEL_OUT \
  ai_peak_detection_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PEAK_DETECTION_MODEL_OUT_SIZE { \
  AI_PEAK_DETECTION_MODEL_OUT_1_SIZE, \
}
#define AI_PEAK_DETECTION_MODEL_OUT_SIZE_BYTES { \
  AI_PEAK_DETECTION_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_PEAK_DETECTION_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PEAK_DETECTION_MODEL_OUT_1_HEIGHT      (256)
#define AI_PEAK_DETECTION_MODEL_OUT_1_CHANNEL     (1)
#define AI_PEAK_DETECTION_MODEL_OUT_1_SIZE        (256)
#define AI_PEAK_DETECTION_MODEL_OUT_1_SIZE_BYTES  (1024)

/******************************************************************************/
#define AI_PEAK_DETECTION_MODEL_N_NODES (16)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup peak_detection_model
 ...
 * @ref ai_peak_detection_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_peak_detection_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_peak_detection_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_peak_detection_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PEAK_DETECTION_MODEL_*
 * defines into file @ref peak_detection_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_peak_detection_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PEAK_DETECTION_MODEL_H */
