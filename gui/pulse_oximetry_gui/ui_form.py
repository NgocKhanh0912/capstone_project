...
class Ui_User_UI(object):
    def setupUi(self, User_UI):
        ...
        self.Threshold.setGeometry(QRect(30, 210, 451, 201))
        ...
        self.Notification.setGeometry(QRect(30, 560, 451, 161))
        ...
        self.line_thre_noti.setGeometry(QRect(150, 100, 281, 26))
        self.lbl_heart_rate = QLabel(self.Notification)
        self.lbl_heart_rate.setObjectName(u"lbl_heart_rate")
        self.lbl_heart_rate.setGeometry(QRect(20, 40, 121, 20))
        self.line_heart_rate = QLineEdit(self.Notification)
        self.line_heart_rate.setObjectName(u"line_heart_rate")
        self.line_heart_rate.setGeometry(QRect(220, 30, 113, 41))
        self.lbl_bpm_3 = QLabel(self.Notification)
        self.lbl_bpm_3.setObjectName(u"lbl_bpm_3")
        self.lbl_bpm_3.setGeometry(QRect(350, 40, 71, 20))
        self.Interval = QGroupBox(self.centralwidget)
        self.Interval.setObjectName(u"Interval")
        self.Interval.setGeometry(QRect(30, 420, 451, 131))
        self.lbl_interval = QLabel(self.Interval)
        self.lbl_interval.setObjectName(u"lbl_interval")
        self.lbl_interval.setGeometry(QRect(70, 30, 81, 20))
        self.line_set_interval = QLineEdit(self.Interval)
        self.line_set_interval.setObjectName(u"line_set_interval")
        self.line_set_interval.setGeometry(QRect(220, 20, 113, 41))
        self.lbl_s = QLabel(self.Interval)
        self.lbl_s.setObjectName(u"lbl_s")
        self.lbl_s.setGeometry(QRect(350, 30, 31, 20))
        self.btn_set_interval = QPushButton(self.Interval)
        self.btn_set_interval.setObjectName(u"btn_set_interval")
        self.btn_set_interval.setGeometry(QRect(170, 80, 111, 29))
    ...
    def retranslateUi(self, User_UI):
        ...
        self.Notification.setTitle(QCoreApplication.translate("User_UI", u"Current heart rate", None))
        self.lbl_thre_noti.setText(QCoreApplication.translate("User_UI", u"Threshold status:", None))
        self.lbl_heart_rate.setText(QCoreApplication.translate("User_UI", u"Heart rate:", None))
        self.lbl_bpm_3.setText(QCoreApplication.translate("User_UI", u"BPM", None))
